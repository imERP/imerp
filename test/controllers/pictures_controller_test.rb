...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { file: @picture.file, iread_id: @picture.iread_id, url: @picture.url } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { file: @picture.file, iread_id: @picture.iread_id, url: @picture.url } }
